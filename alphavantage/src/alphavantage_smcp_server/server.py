"""Alpha Vantage MCP Server with SMCP credential injection."""
...
def main() -> None:
    ...
    logger.info("Starting Alpha Vantage SMCP server")

    # Create client from credentials
    try:
        config = AlphaVantageConfig.from_smcp_creds(creds)
    ...
    logger.info("Alpha Vantage SMCP server ready")
